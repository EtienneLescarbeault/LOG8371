...
public class ImageChartUtils {
    ...
    public static void writeChartNumericData(PointTimeSeriesCollection pointTimeSeriesCollection, XYPlot plot, double numericMax, double numericMin) {
    ...
    public static void writeChartDiscreteData(PointTimeSeriesCollection pointTimeSeriesCollection, XYPlot plot, double numericMax, double numericMin) {
    ...
    public static void writeChart(PointTimeSeriesCollection pointTimeSeriesCollection, boolean showLegend,
        ...
        if (pointTimeSeriesCollection.hasNumericData()) {
            writeChartNumericData(pointTimeSeriesCollection, plot, numericMax, numericMin);
        }
        else
            plot.getRangeAxis().setVisible(false);

        if (pointTimeSeriesCollection.hasDiscreteData()) {
            writeChartDiscreteData(pointTimeSeriesCollection, plot, numericMax, numericMin);
        }
